...
- Only `Qwen3-TTS-12Hz-1.7B-VoiceDesign` is exposed in the UI/model manifest for this iteration.
- Service worker + app assets are deployment-stamped with a build id to force cache refresh on each Pages deploy.
